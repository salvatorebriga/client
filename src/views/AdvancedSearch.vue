        ...
        <div class="flex flex-col md:flex-row gap-0 md:gap-2">
          ...
          <div class="flex-1">
            <input
              ...
              type="text"
              id="query"
              class="border border-gray-300 rounded-t md:rounded-l md:rounded-tr-none p-2 w-full mb-2 text-black dark:bg-gray-900 dark:border-none dark:text-white focus:outline-none"
